...
var favoriteFoods = ["steak", "rice", "oysters", "pasta", "gyro", "gummy worms", "bacon"];
...
for(var i = 0; i < shapes.length; i++) {
    ...
    if(shapes[i] === "triangle")
        console.log("that's my favorite shape!")
}
// TODO: What happens if we change var i = 1? or var i = 2;
// the iteration starts at that index instead
// TODO: What are benefits of using loops to iterate?
// less typing and easy expansion
...
var hadClass = ["justin", "sophie", "david"];
for(var i = 0; i < instructors.length; i++) {
    console.log(instructors[i]);
    if(hadClass.indexOf(instructors[i]) != -1)
